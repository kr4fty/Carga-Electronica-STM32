...
void menu_init(){
    ...
    subMenu1->subMenu[1] = MenuItem("Atras", menu_goback);

    // Submenu "Modo"
    MenuItem* subMenu2 = new MenuItem("Modo de trbjo");
    subMenu2->subMenuItemCount = 7;
    ...
    subMenu2->subMenu[4] = MenuItem("Test de Carga",  menu_loadTest);
    subMenu2->subMenu[5] = MenuItem("Clear Mode", menu_setDefeultMode);
    subMenu2->subMenu[6] = MenuItem("Atras", menu_goback);
    ...
    menu.addSubMenu("Modo de trbjo", subMenu2);
